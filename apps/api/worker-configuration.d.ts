/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17d0672ab986475f9582309981cb0d1e)
// Runtime types generated with workerd@1.20260918.1 2026-09-19 
interface __BaseEnv_Env {
	...
	SECURE_COOKIES: "true";
	HSTS_ENABLED: "true";
	WEB_URL: "https://devhub404.org";
	EMAIL_FROM_ADDRESS: "noreply@devhub404.org";
	CONTACT_RECIPIENT_ADDRESS: "contact@devhub404.org";
	OAUTH_GITHUB_CLIENT_ID: "Ov23li4CEvTf1O8NE8zN";
	OAUTH_GITHUB_REDIRECT_URI: "https://devhub404.org/auth/oauth/github/callback";
	OAUTH_GITHUB_LINK_REDIRECT_URI: "https://devhub404.org/auth/oauth/github/link/callback";
	OAUTH_GOOGLE_CLIENT_ID: "245676201085-ji5m2evv2sn2cqintnt8mvm9d6qg1ku1.apps.googleusercontent.com";
	OAUTH_GOOGLE_REDIRECT_URI: "https://devhub404.org/auth/oauth/google/callback";
	OAUTH_GOOGLE_LINK_REDIRECT_URI: "https://devhub404.org/auth/oauth/google/link/callback";
	PASSKEY_RP_ID: "devhub404.org";
	PASSKEY_RP_NAME: "DevHub 404";
	PASSKEY_ORIGIN: "https://devhub404.org";
	PLATFORM_ACCOUNT_ID: "73619a2e9bf6d17ca18832dbe81a8f46";
	OBJECT_STORE_BUCKET: "devhub-images";
	OBJECT_STORE_ENDPOINT_URL: "https://73619a2e9bf6d17ca18832dbe81a8f46.r2.cloudflarestorage.com";
	OBJECT_STORE_PUBLIC_BASE_URL: "https://images.devhub404.org";
	...
	AUTH_TOTP_SECRET_ENCRYPTION_KEY_BASE64: string;
	OBJECT_STORE_ACCESS_KEY_ID: string;
	OBJECT_STORE_SECRET_ACCESS_KEY: string;
	API_CONTAINER: DurableObjectNamespace<import("./src/worker").DevHubApiContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "DevHubApiContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_PORT" | "HTTP_HOST" | "LOG_LEVEL" | "OPENAPI_ENABLED" | "EMAIL_PROVIDER" | "SECURE_COOKIES" | "HSTS_ENABLED" | "WEB_URL" | "EMAIL_FROM_ADDRESS" | "CONTACT_RECIPIENT_ADDRESS" | "OAUTH_GITHUB_CLIENT_ID" | "OAUTH_GITHUB_REDIRECT_URI" | "OAUTH_GITHUB_LINK_REDIRECT_URI" | "OAUTH_GOOGLE_CLIENT_ID" | "OAUTH_GOOGLE_REDIRECT_URI" | "OAUTH_GOOGLE_LINK_REDIRECT_URI" | "PASSKEY_RP_ID" | "PASSKEY_RP_NAME" | "PASSKEY_ORIGIN" | "PLATFORM_ACCOUNT_ID" | "OBJECT_STORE_BUCKET" | "OBJECT_STORE_ENDPOINT_URL" | "OBJECT_STORE_PUBLIC_BASE_URL" | "MEDIA_UPLOAD_GRANT_TTL_SECONDS" | "MEDIA_ALLOWED_CONTENT_TYPES" | "MEDIA_AVATAR_MAX_BYTES" | "MEDIA_CONTENT_MAX_BYTES" | "AUTH_CACHE_TTL_SECONDS" | "DB_PRIMARY_URL" | "DB_READONLY_URL" | "JWT_SECRET" | "CACHE_REDIS_URL" | "CACHE_REDIS_TOKEN" | "RATE_LIMIT_REDIS_URL" | "OAUTH_GITHUB_CLIENT_SECRET" | "OAUTH_GOOGLE_CLIENT_SECRET" | "OPAQUE_SERVER_SETUP" | "AUTH_TOTP_SECRET_ENCRYPTION_KEY_BASE64" | "OBJECT_STORE_ACCESS_KEY_ID" | "OBJECT_STORE_SECRET_ACCESS_KEY">> {}
}
