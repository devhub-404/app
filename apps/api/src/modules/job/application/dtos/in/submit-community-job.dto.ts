...
import { COMP_UNITS, JOB_TYPES, TAG_SLUG, WORKPLACE_TYPES } from '../dto.constants';

export class SubmitCommunityJobDTO {
  ...
  @ValidateIf((v: SubmitCommunityJobDTO) => v.workplaceType !== 'remote')
  @IsString()
